...
class TSmallWignerd {
   ...
   Double_t* Get(const TWignerd& wig,Int_t m,Int_t n,Int_t& nDimRet) const;
    void setNoOfElements()
    {
        nDim_internal=*(fEven->GetN());
    }
    Int_t getNoOfElements()
    {
        return nDim_internal;
    }
};
